...
export const DCU_SEED_DATA: FranchiseMedia[] = [
  ...
  },
  {
    ...
    "overview": "The DCU introduction of Batman and his assassin-trained biological son Damian Wayne as Robin."
  },
  {
    "id": "dcu-126",
    "universe": "dcu",
    ...
    "is_released": false,
    "release_date": "2027-01-01",
    "overview": "Amanda Waller navigates political intrigue and the fallout of Project Butterfly alongside her ARGUS agents and Team Peacemaker.",
    "seasons": 1
  },
  {
    "id": "dcu-127",
    ...
    "overview": "A dark gothic horror film exploring the supernatural origins and tragic humanity of Swamp Thing."
  },
  {
    "id": "dcu-128",
    "universe": "dcu",
    ...
    "overview": "A loser from the future uses basic future technology to travel back in time to the present day and pretend to be a beloved superhero.",
    "seasons": 1
  },
  {
    "id": "dcu-129",
    ...
    "overview": "A live-action DC Universe adaptation focusing on the iconic team of young superheroes led by Robin."
  },
  {
    "id": "dcu-130",
    "universe": "dcu",
    ...
    "overview": "An animated DC Universe series following the adventures of Jaime Reyes and his symbiote Scarab armor.",
    "seasons": 1
  },
  {
    "id": "dcu-131",
    ...
    "overview": "The direct sequel to Matt Reeves' The Batman (2022), continuing Bruce Wayne's fight for Gotham City's soul."
  }
];
